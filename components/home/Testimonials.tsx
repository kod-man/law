...
const Testimonials = () => {
  return (
    ...
    <div className="bg-grey relative overflow-hidden before:bg-[#1a2431] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:content-[''] before:opacity-70 before:z-[2]">
      ...
      <div className="container lg:pt-24 pt-16 lg:pb-20 sm:pb-14 pb-32 pb-14 relative z-[3]">    
        <h2 className="text-center pb-2 sm:text-[40px] text-[25px] text-white font-bold relative z-[1] before:absolute before:left-0 before:right-0 before:m-auto before:bottom-0 before:w-36 before:h-[3px] before:bg-white mb-12">What Our Customers Say</h2>
