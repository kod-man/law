              ...
              <div className="mb-12 pb-12 relative before:absolute before:bottom-0 before:left-0 before:w-full before:h-[3px] before:content-[''] before:bg-background after:absolute after:content-[''] after:w-[150px] after:h-[3px] after:bg-primary-main after:bottom-0 after:left-0 after:z-[1]">
                ...
                <div className=" bg-white">
                  ...
                  <ul className="flex pb-5">
                    <li><Link href="" className="text-base text-primary-main pr-1">Child Custody</Link>,</li>
                    <li className="ml-1"><Link href="#" className="text-base text-primary-main pr-1">Family Law</Link>,</li>
                    <li className="ml-1"><Link href="#" className="text-base text-primary-main pr-1">Infomatics</Link>,</li>
                    <li className="ml-1"><Link href="#" className="text-base text-primary-main pr-1">Legal Advise</Link>,</li>
                    <li className="ml-1"><Link href="#" className="text-base text-primary-main pr-1"> News</Link>,</li>
                  </ul>
                  <p className="text-base text-[#333] leading-[1.62] mb-4">Many people are not aware of their legal rights and dont pay attention to the helping hand they can get from legal advise. Therefore it is very important to know that you are aware of your rights and seek legal help when needed.</p>
                  ...
                  <h3 className="text-[32px] text-[#333] font-bold pr-12 mb-3">What To Do First When Encounter An Accident?</h3>
